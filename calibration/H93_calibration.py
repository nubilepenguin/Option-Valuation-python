...
for row, option in options.iterrows():
    ...
    options.loc[row, 'r'] = -math.log(BOT) / T
...
def H93_error_function(p0):
    ...
    se = []
    for row, option in options.iterrows():
        model_value = H93_call_value(S0, option['Strike'], option['T'], option['r'],
