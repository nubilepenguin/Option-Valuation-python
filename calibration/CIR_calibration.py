...
import math
import numpy as np
np.set_printoptions(suppress=True, formatter={'all': lambda x: '%7.6f' % x})
...
def plot_zcb_values(p0, T):
    ...
    r_list = []
    for t in t_list:
        alpha = r0, p0[0], p0[1], p0[2], t, T
        r_list.append(B(alpha))
    plt.figure(figsize=(8, 5))
...
# plot_term_structure()
# opt1 = CIR_calibration()
# plot_calibrated_frc(opt1)
# plot_zcb_values(p0=opt1, T=4)
