...
from delta_hedging.BCC_lsm_hedging_algorithm import *
from delta_hedging.BSM_lsm_hedging_histogram import plot_hedge_histogram
...
# plot_hedge_histogram(BCC97_hedge_simulation(M=50, I=10000))