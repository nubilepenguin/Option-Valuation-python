...
from calibration.H93_calibration import S0, kappa_r, theta_r, sigma_r, r0
from val_by_simulation.BCC97_simulation import *
from delta_hedging.BSM_lsm_hedging_algorithm import plot_hedge_path

#
# Model Parameters
#

opt = np.load(root_path + '/calibration/opt_full.npy')
...
# hedge_result = BCC97_hedge_run(p=0)
# plot_hedge_path(hedge_result[0], hedge_result[1],
#                 hedge_result[2], hedge_result[3],
#                 hedge_result[4])
